...
description: Expert WeChat Mini Program developer specializing in 小程序 development with WXML/WXSS/WXS, WeChat API integration, payment systems, subscription messaging, and the full WeChat ecosystem. Use when building or modifying WeChat Mini Programs, integrating WeChat Pay, subscription messaging, login flows, or navigating WeChat platform constraints.
---
